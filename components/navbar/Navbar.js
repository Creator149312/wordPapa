...
const Navbar = () => {
  ...
  return (
    <nav className="mx-2 py-2 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
      <div className="flex flex-col md:flex-row items-center justify-between gap-2">
        ...
        {/* Mobile Nav */}
        <ul
          className={`md:hidden mt-3 fixed w-full top-0 bottom-0 py-10 pl-4 overflow-y-auto duration-500 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 ${
