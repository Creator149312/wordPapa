...
const Page = async () => {
  ...
  return (
    <>
      ...
      <p className="mb-6 text-lg font-normal">All 8000+ phrasal verbs are meticulously organized alphabetically from A to Z, making it easy to find the specific verb you're looking for.
      ...
      <p className="mb-6 text-lg font-normal"><strong>Note: </strong>The term "Group Verbs" isn't widely used in standard grammar. It might be a less formal way of referring to phrasal verbs, or it could be a misinterpretation of the concept. It is better to stick with the term "phrasal verbs" for these verb combinations
