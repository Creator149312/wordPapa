  ...
  return (
    <div className="py-8 space-y-6">
      ...
      <p className="px-2 text-sm text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
        All action words ending with <strong className="text-gray-700 dark:text-white">{L}</strong> are sorted by length. Includes conjugations in different tenses (past, present, future) and moods (indicative, imperative, subjunctive).
      </p>
    </div>
  );
};
