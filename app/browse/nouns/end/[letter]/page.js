  ...
  return (
    <div className="py-8 space-y-6">
      ...
      <p className="px-2 text-sm text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
        All nouns ending with <strong className="text-gray-700 dark:text-white">{L}</strong> are sorted by length for easy browsing. Includes common nouns, proper nouns, concrete nouns, and abstract nouns.
      </p>
    </div>
  );
};
