...
export async function generateMetadata({ params }, parent) {
  ...
  // read route params
  titleStr = `The Complete List of Nouns in English`;
  const descriptionStr = `Browse all 80000+ nouns which are commonly used in English language as a person, place or thing.`;
  return {
    title: titleStr,
