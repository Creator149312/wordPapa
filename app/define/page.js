    ...
    <div className="max-w-4xl mx-auto px-4 md:px-6 py-8 md:py-12 min-h-screen">
      ...
      <div className="space-y-6 md:space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 md:p-8 bg-gray-50 dark:bg-white/5 rounded-[2rem] border-2 border-transparent hover:border-[#75c32c]/20 transition-all group">
            <BookOpen className="text-[#75c32c] mb-4 group-hover:scale-110 transition-transform" size={28} />
            <h3 className="text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Definitions</h3>
          ...
          <div className="p-6 md:p-8 bg-gray-50 dark:bg-white/5 rounded-[2rem] border-2 border-transparent hover:border-[#75c32c]/20 transition-all group">
            ...
            <h3 className="text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Parts of Speech</h3>
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 font-medium leading-relaxed">
          ...
          <div className="p-6 md:p-8 bg-gray-50 dark:bg-white/5 rounded-[2rem] border-2 border-transparent hover:border-[#75c32c]/20 transition-all group">
            ...
            <h3 className="text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Sentence Examples</h3>
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 font-medium leading-relaxed">
        ...
        {/* Usage note */}
        <section className="p-6 md:p-8 bg-white dark:bg-[#111] border border-gray-100 dark:border-gray-800 rounded-[2rem] md:rounded-[2.5rem]">
